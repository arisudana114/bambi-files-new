            ...
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <aside className="md:w-1/4">
                <article className="border border-gray-200 bg-white shadow-sm rounded mb-5 p-3 lg:p-5">
                  ...
                  <a
                    className="px-4 py-3 mb-2 inline-block text-lg w-full text-center font-medium text-white bg-[#193f88] border border-transparent rounded-md hover:bg-[#0a2c6c] cursor-pointer"
                  ...
                  <Link
                    href="/"
                    className="px-4 py-3 inline-block text-lg w-full text-center font-medium text-[#193f88] bg-white shadow-sm border border-gray-200 rounded-md hover:bg-gray-100"
                  >
                    Back to shop
                  </Link>
                </article>
